...
from internals import find_file, find_jar, config_java, java, _java_options
...
class StanfordTagger(TaggerI):
    ...
    def __init__(self, path_to_model, path_to_jar=None, encoding='ascii', verbose=False, java_options='-mx1000m'):#'-Xmx4g'):
